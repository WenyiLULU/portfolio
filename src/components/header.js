    ...
    return (
        <header id="top" className="navbar shadow-lg bg-primary text-neutral-content rounded-b-box">
            ...
            <div className="navbar-end">
                <div className="dropdown  dropdown-end avatar md:hidden">
                    ...
                    <div tabIndex="0" className="shadow menu dropdown-content rounded-box">
                        <div className="artboard artboard-demo">
                            <ul className="menu py-4 shadow-lg bg-white rounded-box">
